...
def complete_with_retry(
    ...
    What to do:
      ...
      - on ThrottleError: wait, then try again — up to `settings.model_max_retries` retries.
        ...
        `attempt` starts at 0. That doubling is called exponential backoff.
      - if the retries run out, let the last ThrottleError propagate.
    ...
    while True:
        try:
            ...
            # FatalError and all other exceptions are raised immediately
            raise
